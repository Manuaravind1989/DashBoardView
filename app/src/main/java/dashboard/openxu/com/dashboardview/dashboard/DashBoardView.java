package dashboard.openxu.com.dashboardview.dashboard;
...
import dashboard.openxu.com.dashboardview.DensityUtil;
import dashboard.openxu.com.dashboardview.FontUtil;
import dashboard.openxu.com.dashboardview.LogUtil;
import dashboard.openxu.com.dashboardview.R;
...
public class DashBoardView extends BaseChart {
    ...
    private int textSizeCoordinate = (int)getResources().getDimension(R.dimen.text_size_chart_coordinate);
    private int textSizeLable = DensityUtil.sp2px(getContext(), 13);
    private int textColorCoordinate = getResources().getColor(R.color.text_color_chart_coordinate);
    private int textColorLable = getResources().getColor(R.color.text_color_chart_lable);
